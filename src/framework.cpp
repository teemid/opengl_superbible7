...
{
    void Application::Init (void) { std::cout << "Application::Init\n"; }

    void Application::Render (double currentTime) { std::cout << "Application::Render\n"; }

    void Application::Shutdown (void) { std::cout << "Application::Shutdown\n"; }
    ...
    GLuint CompileShader (GLenum type, const GLchar * source)
    {
        ...
        if (GL_FALSE == status)
        {
            ...
            GLchar * log = BUFFER(GLchar, length + 1);
