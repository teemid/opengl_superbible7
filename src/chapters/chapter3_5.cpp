...
static GLchar * geometry_source = SHADER(450 core,
    layout (triangles) in;
...
void Chapter3_5::Init (void)
{
    ...
    GLuint geometry_shader     = CompileShader(GL_GEOMETRY_SHADER,        geometry_source);
...
void Chapter3_5::Render (double currentTime)
{
